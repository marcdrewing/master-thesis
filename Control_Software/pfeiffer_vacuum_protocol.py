...
def read_pressure(s, addr, valid_char_filter=None):
    ...
    # Convert to a float
    mantissa = int(rdata[:4]) #typically something like 6394
    exponent = int(rdata[4:]) #typically something like 15 at normal pressure
    #datasheet says to remove 20 from exponent --> 6,394*10^(15-20) = 6394*10^(-3)
    #print(rdata)
    #print(mantissa)
    #print(exponent-26)
